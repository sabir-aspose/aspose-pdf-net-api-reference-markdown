...
source_url: "https://reference.aspose.com/pdf/net/aspose.pdf.lowcode/formtextboxfieldcreateoptions/"
generated_from: "online-reference"
fetched_at: "2026-06-14T04:29:56+00:00"
---
## FormTextBoxFieldCreateOptions class {#formtextboxfieldcreateoptions-class}

Represents options for creating TextBoxField by [`FormEditor`](../formeditor/) plugin.
...
| Name | Description |
| --- | --- |
| [FormTextBoxFieldCreateOptions](formtextboxfieldcreateoptions/)(int, Rectangle) | Initializes a new instance of the `FormTextBoxFieldCreateOptions` object, that containing parameters for created and added TextBoxField. |
...
| [ForceCombs](../../aspose.pdf.lowcode/formtextboxfieldcreateoptions/forcecombs/) { get; set; } | Gets/sets the value to determine whether created TextBoxField is forcecombs or not (if will be set). |
| [IsSharedField](../../aspose.pdf.lowcode/formfieldoptions/issharedfield/) { get; set; } | Gets/sets the value to determine whether created/modified field is shared field or not (if will be set). |
| [MappingName](../../aspose.pdf.lowcode/formfieldoptions/mappingname/) { get; set; } | Gets/sets the value to determine property MappingName for created/modified field (if will be set). |
...
| [MaxLen](../../aspose.pdf.lowcode/formtextboxfieldcreateoptions/maxlen/) { get; set; } | Gets/sets the value to determine property MaxLen for created TextBoxField (if will be set). |
...
| [Multiline](../../aspose.pdf.lowcode/formtextboxfieldcreateoptions/multiline/) { get; set; } | Gets/sets the value to determine whether created TextBoxField is multiline or not (if will be set). |
...
| [SpellCheck](../../aspose.pdf.lowcode/formtextboxfieldcreateoptions/spellcheck/) { get; set; } | Gets/sets the value to determine whether created TextBoxField is spellcheck or not (if will be set). |
...
| [Value](../../aspose.pdf.lowcode/formfieldoptions/value/) { get; set; } | Gets/sets the value to determine property Value for created/modified field (if will be set). |

## Fields {#fields}

| Name | Description |
| --- | --- |
| [Highlighting](../../aspose.pdf.lowcode/formfieldoptions/highlighting/) | Gets/sets the value to determine property Highlighting for created/modified field (if will be set). |
