...
source_url: "https://reference.aspose.com/pdf/net/aspose.pdf.lowcode/formtextboxfieldsetoptions/"
generated_from: "online-reference"
fetched_at: "2026-06-14T04:30:01+00:00"
---
## FormTextBoxFieldSetOptions class {#formtextboxfieldsetoptions-class}

Represents options for set properties in TextBoxField by [`FormEditor`](../formeditor/) plugin.
...
| Name | Description |
| --- | --- |
| [FormTextBoxFieldSetOptions](formtextboxfieldsetoptions/)() | The default constructor. |
...
| [ForceCombs](../../aspose.pdf.lowcode/formtextboxfieldsetoptions/forcecombs/) { get; set; } | Gets/sets the value to determine property ForceCombs for modified field (if will be set). |
...
| [MaxLen](../../aspose.pdf.lowcode/formtextboxfieldsetoptions/maxlen/) { get; set; } | Gets/sets the value to determine property MaxLen for modified field (if will be set). |
...
| [Multiline](../../aspose.pdf.lowcode/formtextboxfieldsetoptions/multiline/) { get; set; } | Gets/sets the value to determine property Multiline for modified field (if will be set). |
...
| [SpellCheck](../../aspose.pdf.lowcode/formtextboxfieldsetoptions/spellcheck/) { get; set; } | Gets/sets the value to determine property SpellCheck for modified field (if will be set). |
