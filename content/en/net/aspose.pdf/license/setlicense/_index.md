...
source_url: "https://reference.aspose.com/pdf/net/aspose.pdf/license/setlicense/"
...
1. The folder that contains the Aspose component JAR file.
2. The folder that contains the client’s calling JAR file.
