...
source_url: "https://reference.aspose.com/pdf/net/aspose.pdf.forms/listboxfield/"
generated_from: "online-reference"
fetched_at: "2026-06-14T04:22:06+00:00"
---
## ListBoxField class {#listboxfield-class}
...
| Name | Description |
| --- | --- |
| [ListBoxField](listboxfield/#constructor)() | Constructor for ListBoxField to be used in Generator. |
| [ListBoxField](listboxfield/#constructor_1)(Document, Rectangle) | Constructor for ListBox field. |
| [ListBoxField](listboxfield/#constructor_2)(Page, Rectangle) | Creates new ListBox field. |
...
| override [Selected](../../aspose.pdf.forms/listboxfield/selected/) { set; } | Gets or sets index of the selected item. Items are numbered from 1. |
| override [SelectedItems](../../aspose.pdf.forms/listboxfield/selecteditems/) { set; } | Gets or sets array of the selected items in the multiselect list. For single-select list returns array with single item. |
...
| [TopIndex](../../aspose.pdf.forms/listboxfield/topindex/) { get; set; } | Gets or sets index of the top visible element of the list. |
...
| virtual [AddOption](../../aspose.pdf.forms/choicefield/addoption/)(string) | Adds new option with specified name. |
