...
source_url: "https://reference.aspose.com/pdf/net/aspose.pdf.forms/buttonfield/"
generated_from: "online-reference"
fetched_at: "2026-06-14T04:20:39+00:00"
---
## ButtonField class {#buttonfield-class}
...
| Name | Description |
| --- | --- |
| [ButtonField](buttonfield/#constructor)() | Button field constructor for Generator. |
| [ButtonField](buttonfield/#constructor_1)(Document, Rectangle) | ButtonField constructore. |
| [ButtonField](buttonfield/#constructor_2)(Page, Rectangle) | ButtonField constructor. |
...
| [AlternateCaption](../../aspose.pdf.forms/buttonfield/alternatecaption/) { get; set; } | Gets or sets alternate caption of the button which shall be displayed when the mouse button is pressed within its active area. |
| [AlternateIcon](../../aspose.pdf.forms/buttonfield/alternateicon/) { get; set; } | Gets or sets alternate icon which shall be displayed when the mouse button is pressed within its active area. |
...
| [IconFit](../../aspose.pdf.forms/buttonfield/iconfit/) { get; } | Gets icon fit object specifying how the widget annotation’s icon shall be displayed within its annotation rectangle. |
| [ICPosition](../../aspose.pdf.forms/buttonfield/icposition/) { get; set; } | Gets or sets icon caption position. |
...
| [NormalCaption](../../aspose.pdf.forms/buttonfield/normalcaption/) { get; set; } | Gets or sets normal caption. |
| [NormalIcon](../../aspose.pdf.forms/buttonfield/normalicon/) { get; set; } | Gets or sets normal icon of the button which shall be displayed when it is not interacting with the user. |
...
| [RolloverCaption](../../aspose.pdf.forms/buttonfield/rollovercaption/) { get; set; } | Gets or sets rollover caption of button which shall be displayed when the user rolls the cursor into its active area without pressing the mouse button. |
| [RolloverIcon](../../aspose.pdf.forms/buttonfield/rollovericon/) { get; set; } | Gets or sets rollover icon of the button which shall be displayed when the user rolls the cursor into its active area without pressing the mouse button. |
