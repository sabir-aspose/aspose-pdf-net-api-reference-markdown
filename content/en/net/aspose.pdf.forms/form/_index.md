...
source_url: "https://reference.aspose.com/pdf/net/aspose.pdf.forms/form/"
generated_from: "online-reference"
fetched_at: "2026-06-14T04:21:44+00:00"
---
...
| [HasXfa](../../aspose.pdf.forms/form/hasxfa/) { get; } | Gets a value indicating whether the document contains XFA form. This property was introduced to determine if [`IgnoreNeedsRendering`](./ignoreneedsrendering/) should be used to remove the XFA form in cases where the XFA form is present and [`NeedsRendering`](./needsrendering/) is false. |
...
| [NeedsRendering](../../aspose.pdf.forms/form/needsrendering/) { get; } | Gets a value indicating whether the document requires the removal of the dynamic XFA form. This property was introduced to determine if [`IgnoreNeedsRendering`](./ignoreneedsrendering/) should be used to remove the XFA form in cases where the XFA form is present and [`NeedsRendering`](./needsrendering/) is false. |
