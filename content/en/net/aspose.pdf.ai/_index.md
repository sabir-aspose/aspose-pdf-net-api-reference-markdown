...
source_url: "https://reference.aspose.com/pdf/net/aspose.pdf.ai/"
...
| [ChatMessageResponse](./chatmessageresponse/) | A chat completion message generated by the model. |
| [Choice](./choice/) | Represents a choice in a chat completion response. |
| [ChunkingOptions](./chunkingoptions/) | Configuration options for document chunking operations. |
...
| [DocumentExtensions](./documentextensions/) | Extension methods for [`Document`](../aspose.pdf/document/) to support AI ingestion and chunking. |
...
| [TextRecognitionResult](./textrecognitionresult/) | Represents the aggregated OCR results for a single source document. |
