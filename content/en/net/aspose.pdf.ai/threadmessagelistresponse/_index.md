...
source_url: "https://reference.aspose.com/pdf/net/aspose.pdf.ai/threadmessagelistresponse/"
generated_from: "online-reference"
fetched_at: "2026-06-14T03:57:25+00:00"
---
## ThreadMessageListResponse class {#threadmessagelistresponse-class}

Represents a list response containing thread message data.

```csharp
public class ThreadMessageListResponse : ListDataResponse<List<ThreadMessageResponse>>
```
...
| Name | Description |
| --- | --- |
| [ThreadMessageListResponse](threadmessagelistresponse/)() | The default constructor. |
