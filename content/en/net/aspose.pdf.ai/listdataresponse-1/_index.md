...
description: "Aspose.Pdf.AI.ListDataResponse1T class. Represents a list data response containing additional information such as first and last IDs and whether there are more items"
type: docs
url: "/net/aspose.pdf.ai/listdataresponse-1/"
source_url: "https://reference.aspose.com/pdf/net/aspose.pdf.ai/listdataresponse-1/"
generated_from: "online-reference"
fetched_at: "2026-06-14T03:51:58+00:00"
---
## ListDataResponse<T> class {#listdataresponselttgt-class}
...
| [FirstId](../../aspose.pdf.ai/listdataresponse-1/firstid/) { get; set; } | Gets or sets the first ID in the list. |
| [HasMore](../../aspose.pdf.ai/listdataresponse-1/hasmore/) { get; set; } | Gets or sets a value indicating whether there are more items in the list. |
...
| [LastId](../../aspose.pdf.ai/listdataresponse-1/lastid/) { get; set; } | Gets or sets the last ID in the list. |
