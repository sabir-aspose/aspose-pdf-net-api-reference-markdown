...
source_url: "https://reference.aspose.com/pdf/net/aspose.pdf.ai/vectorstorefilebatchresponse/"
generated_from: "online-reference"
fetched_at: "2026-06-14T03:58:29+00:00"
---
## VectorStoreFileBatchResponse class {#vectorstorefilebatchresponse-class}
...
| Name | Description |
| --- | --- |
| [CreatedAt](../../aspose.pdf.ai/vectorstorefilebatchresponse/createdat/) { get; set; } | Gets or sets the Unix timestamp (in seconds) for when the vector store files batch was created. |
...
| [FileCounts](../../aspose.pdf.ai/vectorstorefilebatchresponse/filecounts/) { get; set; } | Gets or sets the number of files that have been processed. |
...
| [Id](../../aspose.pdf.ai/vectorstorefilebatchresponse/id/) { get; set; } | Gets or sets the identifier, which can be referenced in API endpoints. |
| [IsSuccessful](../../aspose.pdf.ai/baseresponse/issuccessful/) { get; } | Indicates if the response was successful. |
| [Object](../../aspose.pdf.ai/vectorstorefilebatchresponse/object/) { get; set; } | Gets or sets the object type, which is always vector_store.file_batch. |
| [ReasonPhrase](../../aspose.pdf.ai/baseresponse/reasonphrase/) { get; } | Gets the error reason phrase. |
| [Status](../../aspose.pdf.ai/vectorstorefilebatchresponse/status/) { get; set; } | Gets or sets the status of the vector store file batch. |
| [VectorStoreId](../../aspose.pdf.ai/vectorstorefilebatchresponse/vectorstoreid/) { get; set; } | Gets or sets the ID of the vector store that the File is attached to. |
