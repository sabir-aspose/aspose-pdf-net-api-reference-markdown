...
source_url: "https://reference.aspose.com/pdf/net/aspose.pdf.logicalstructure/listlblelement/"
generated_from: "online-reference"
fetched_at: "2026-06-14T04:25:57+00:00"
---
## ListLblElement class {#listlblelement-class}

Represents Lbl structure element in logical structure of the list.

```csharp
public sealed class ListLblElement : ListChildElement
```
