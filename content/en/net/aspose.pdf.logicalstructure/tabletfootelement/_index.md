...
source_url: "https://reference.aspose.com/pdf/net/aspose.pdf.logicalstructure/tabletfootelement/"
generated_from: "online-reference"
fetched_at: "2026-06-14T04:28:15+00:00"
---
## TableTFootElement class {#tabletfootelement-class}

Represents TFoot structure element in logical structure of the table.

```csharp
public sealed class TableTFootElement : TableRowCollectionElement
```
