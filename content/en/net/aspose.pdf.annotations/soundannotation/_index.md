...
description: "Aspose.Pdf.Annotations.SoundAnnotation class. Represents a sound annotation that contains sound recorded from the computers microphone or imported from a file"
type: docs
url: "/net/aspose.pdf.annotations/soundannotation/"
source_url: "https://reference.aspose.com/pdf/net/aspose.pdf.annotations/soundannotation/"
generated_from: "online-reference"
fetched_at: "2026-06-14T04:06:15+00:00"
---
## SoundAnnotation class {#soundannotation-class}
...
| override [AnnotationType](../../aspose.pdf.annotations/soundannotation/annotationtype/) { get; } | Gets type of annotation. |
...
| [Icon](../../aspose.pdf.annotations/soundannotation/icon/) { get; set; } | Gets or sets an icon to be used in displaying the annotation. |
...
| [SoundData](../../aspose.pdf.annotations/soundannotation/sounddata/) { get; } | Gets a sound object defining the sound to be played when the annotation is activated. |
...
| Name | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/soundannotation/accept/)(AnnotationSelector) | Accepts visitor object to process the annotation. |
