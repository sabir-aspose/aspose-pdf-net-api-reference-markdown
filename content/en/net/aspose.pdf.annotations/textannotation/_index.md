...
source_url: "https://reference.aspose.com/pdf/net/aspose.pdf.annotations/textannotation/"
generated_from: "online-reference"
fetched_at: "2026-06-14T04:07:03+00:00"
---
## TextAnnotation class {#textannotation-class}
...
| Name | Description |
| --- | --- |
| [TextAnnotation](textannotation/#constructor)(Document) | Constructor for annotation when used in Generator. |
| [TextAnnotation](textannotation/#constructor_1)(Page, Rectangle) | Creates new Text annotation on the specified page. |
...
| override [AnnotationType](../../aspose.pdf.annotations/textannotation/annotationtype/) { get; } | Gets type of annotation. |
...
| [Icon](../../aspose.pdf.annotations/textannotation/icon/) { get; set; } | Gets or sets an icon to be used in displaying the annotation. |
...
| [Open](../../aspose.pdf.annotations/textannotation/open/) { get; set; } | Gets or sets a flag specifying whether the annotation should initially be displayed open. |
