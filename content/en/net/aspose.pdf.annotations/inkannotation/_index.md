...
source_url: "https://reference.aspose.com/pdf/net/aspose.pdf.annotations/inkannotation/"
generated_from: "online-reference"
fetched_at: "2026-06-14T04:02:16+00:00"
---
## InkAnnotation class {#inkannotation-class}
...
| Name | Description |
| --- | --- |
| [InkAnnotation](inkannotation/#constructor)(Document, IList<Point[]>) | Constructor for Ink annotation for Generator. |
| [InkAnnotation](inkannotation/#constructor_1)(Page, Rectangle, IList<Point[]>) | Creates new Ink annotation on the specified page. |
...
| override [AnnotationType](../../aspose.pdf.annotations/inkannotation/annotationtype/) { get; } | Gets type of annotation. |
...
| [CapStyle](../../aspose.pdf.annotations/inkannotation/capstyle/) { get; set; } | Style of ink annotation line endings. |
...
| [InkList](../../aspose.pdf.annotations/inkannotation/inklist/) { get; set; } | Gets or sets list of gestures that are independent lines which are represented by Point[] arrays. |
...
| Name | Description |
| --- | --- |
| override [Accept](../../aspose.pdf.annotations/inkannotation/accept/)(AnnotationSelector) | Accepts visitor object to process the annotation. |
| override [ChangeAfterResize](../../aspose.pdf.annotations/inkannotation/changeafterresize/)(Matrix) | Updates the points in InkList, according to the matrix transform. |
