...
source_url: "https://reference.aspose.com/pdf/net/aspose.pdf.dataeditor/cospdfname/"
generated_from: "online-reference"
fetched_at: "2026-06-14T04:09:18+00:00"
---
## CosPdfName class {#cospdfname-class}
...
| Name | Description |
| --- | --- |
| [CosPdfName](cospdfname/)(string) | Initializes a new instance of the `CosPdfName` class. |

## Properties {#properties}

| Name | Description |
| --- | --- |
| [Value](../../aspose.pdf.dataeditor/cospdfname/value/) { get; } | Gets the value. |
...
| override [ToString](../../aspose.pdf.dataeditor/cospdfname/tostring/)() | Returns a String that represents the current `CosPdfName`. |
